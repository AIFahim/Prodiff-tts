    ...
    def __init__(self, processed_data_dir=None):
        ...
        for ds_id, processed_data_dir in enumerate(self.processed_data_dirs):
            ...
            for r_idx, r in self.meta_df.iterrows():
                ...
                self.item2wavfn[item_name] = os.path.join(hparams['raw_data_dir'], 'wavs', os.path.basename(r['wav_fn']).split('/')[-1])
                # print("-------------------------self.item2wavfn[item_name]-----------------",self.item2wavfn[item_name])
